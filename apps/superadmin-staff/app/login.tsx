    ...
    <Screen>
      <View className="justify-center py-8" style={{ minHeight: minContentHeight }}>
        <View className="rounded-[32px] bg-white p-8">
          ...
          <Text className="mt-5 text-[11px] font-black uppercase tracking-[2px] text-primary-500">Superadmin Monitor</Text>
          <Text className="mt-3 text-3xl font-black text-primary-900">
            {mode === 'login' ? 'Vaniki admin staff app.' : mode === 'forgot' ? 'Forgot Password?' : 'Reset Password'}
          </Text>
          <Text className="mt-3 text-sm leading-6 text-primary-900/65">
            {mode === 'login' 
              ? 'Login to view system orders and receive push notifications on new orders.' 
              : mode === 'forgot'
