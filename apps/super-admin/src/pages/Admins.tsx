          ...
          <div
            ...
            className={`cursor-pointer rounded-[1.5rem] border p-4 transition ${
              admin.approvalStatus === 'pending'
                ? 'border-amber-400 bg-amber-50/30 shadow-xs ring-1 ring-amber-300/60'
                : 'border-primary-100 bg-white hover:bg-primary-50/40'
            }`}
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {admin.approvalStatus === 'pending' ? (
                      <span className="rounded-full bg-amber-500 px-2 py-0.5 text-[10px] font-black uppercase text-white shadow-2xs">
                        NEW KYC
                      </span>
                    ) : null}
                  </div>
                  ...
                  <p className="mt-2 text-xs font-semibold uppercase tracking-[0.14em] text-primary-600">
                    Assigned Store: {admin.assignedStore?.name || admin.storeName || 'Unassigned'}
                  </p>
              ...
              <button
                ...
                className="cursor-pointer rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 px-3 py-1.5 text-xs font-bold text-slate-700 transition active:scale-95"
              >
                Edit
              </button>
            </div>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {admin.approvalStatus !== 'approved' ? (
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 px-3.5 py-1.5 text-xs font-black text-white shadow-xs transition active:scale-95"
                  >
                    ✓ Approve
                  </button>
                ) : null}
                ...
                {admin.approvalStatus !== 'rejected' ? (
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-1 rounded-xl border border-rose-200 bg-rose-50 hover:bg-rose-100 px-2.5 py-1.5 text-xs font-bold text-rose-700 transition active:scale-95"
                  >
                    ✕ Reject
                  </button>
                ) : null}
                ...
                {admin.isActive ? (
                  <button
                    ...
                    className="cursor-pointer inline-flex items-center gap-1 rounded-xl border border-amber-200 bg-amber-50 hover:bg-amber-100 px-2.5 py-1.5 text-xs font-bold text-amber-800 transition active:scale-95"
                  >
                    Deactivate
                  </button>
                ) : null}
                ...
                <button
                  ...
                  className="cursor-pointer inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white hover:bg-rose-50 hover:border-rose-200 hover:text-rose-600 px-2.5 py-1.5 text-xs font-bold text-slate-500 transition active:scale-95"
                >
                  Delete
                </button>
              </div>
