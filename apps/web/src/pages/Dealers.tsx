...
const Dealers: React.FC = () => {
  const handleDownload = () => {
    ...
    link.href = `/dealers-v1.10.5.apk?v=${Date.now()}`;
    link.download = 'dealers-v1.10.5.apk';
              ...
              <div>
                ...
                <ul className="mt-5 space-y-3.5">
                  {[
                    ...
                    "Open your device's **Downloads** or File Manager and tap the downloaded `dealers-v1.10.5.apk` file.",
