...
const rootJsonPath = path.resolve(__dirname, '../../../../vanikicrop-d9355-firebase-adminsdk-fbsvc-a1c26af925.json');
...
try {
  if (admin.apps.length === 0) {
    if (fs.existsSync(rootJsonPath)) {
      ...
      console.log('[FIREBASE] Successfully initialized Firebase Admin using service account JSON file');
